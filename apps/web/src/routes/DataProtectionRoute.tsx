...
import { DataProtectionScreen } from "../data-protection/DataProtectionScreen";
...
/**
 * The association's own data protection records inside the application frame.
 *
 ...
 */
export function DataProtectionRoute(): ReactElement {
  ...
  return (
    ...
    >
      {failed ? (
        ...
        <DataProtectionScreen viewer={viewer} />
      )}
    </AppShell>
  );
}
