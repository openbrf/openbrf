...
/**
 * Plugin management inside the application frame.
 *
 ...
 * with the same request that says what this person may do.
 */
export function PluginsRoute(): ReactElement {
