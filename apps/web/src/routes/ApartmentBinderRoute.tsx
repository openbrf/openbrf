...
import { ApartmentBinderScreen } from "../apartment-binder/ApartmentBinderScreen";
...
/**
 * The apartment binder inside the application frame.
 *
 ...
 * offered to every account: what somebody reads in a binder follows the
 * residencies they hold today, which is the server's answer, so there is
 * nothing here to gate.
 */
export function ApartmentBinderRoute(): ReactElement {
  ...
  return (
    ...
    >
      {failed ? (
        ...
        <ApartmentBinderScreen viewer={viewer} />
      )}
    </AppShell>
  );
}
