...
import { SubletsScreen } from "../sublets/SubletsScreen";
...
/**
 * The subletting screen inside the application frame.
 *
 ...
 */
export function SubletsRoute(): ReactElement {
