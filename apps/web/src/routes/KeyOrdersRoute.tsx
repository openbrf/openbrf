...
import { KeyOrdersScreen } from "../key-orders/KeyOrdersScreen";
...
/**
 * The key order screen inside the application frame.
 *
 ...
 */
export function KeyOrdersRoute(): ReactElement {
