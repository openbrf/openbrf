 ...
 * party a fee is fixed on - the arsavgift is owed for the bostadsratt (BRL 7
 * kap. 14 §) and how it falls between the apartments is the stadgar's question
 * (BRL 9 kap. 5 § forsta stycket 5) - who holds it is on the notice document,
 * and the omission is what keeps one masking rule in this file rather than two
 * opposite ones.
 *
