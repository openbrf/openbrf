...
| rättsligt bevarandekrav | **legal hold** | A recorded reason for keeping one person's service-tier data past its purge date: a dispute, an insurance matter, a request from an authority. GDPR art. 17.3 e is what makes the exception lawful. It suspends purging for that person alone rather than changing the association's retention policy, and it is released with a date rather than deleted, so the record explains why nothing was purged in that period. |
