...
Reviewed against the Scorecard run of 2026-08-29.
...
| ------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Pinned-Dependencies | Work, done           | The base image in `Dockerfile` is pinned by digest, and `.github/dependabot.yml` keeps the pins current. The `npm install --global pnpm@<version>` in the same file stays version-pinned rather than hash-pinned: npm has no integrity check for a global install, and the alternative is corepack, which Node 26 no longer bundles and `CONTRIBUTING.md` forbids.                                                                                                                         |
